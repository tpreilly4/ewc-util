		...
		const data = [
			{
				...
				linkBtns:[
					{ 
						...
						onPress: ()=>Linking.openURL('https://ewccontrols.com/acrobat/090377a0068.pdf')
					},
					{ 
						key: 1,
						title:"Submittal Sheet (En Español)",
						onPress: ()=>Linking.openURL('https://ewccontrols.com/acrobat/090377a0311.pdf')
					},
				],
			},
			{
			...
			},
			{
				...
				linkBtns:[
					{ 
						...
						onPress: ()=>Linking.openURL('https://ewccontrols.com/acrobat/090375a0251.pdf')
					},
					{ 
						key: 1,
						title:"Submittal Sheet (En Español)",
						onPress: ()=>Linking.openURL('https://ewccontrols.com/acrobat/090377a0310.pdf')
					},
				],
			},
			{
